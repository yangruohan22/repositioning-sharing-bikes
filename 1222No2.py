...
PFA_PARAMS = {
    'THETA_SUPPLY_L': 0.20734,  # 供应节点下阈值
    'THETA_SUPPLY_U': 0.37629,  # 供应节点上阈值
    'THETA_DEMAND_L': 1.92608,  # 需求节点下阈值
    'THETA_DEMAND_U': 3.56216,  # 需求节点上阈值
    'TAU_L': 45,  # 库存决策前瞻时间(分钟)
    'TAU_D': 10,  # 路由决策前瞻时间(分钟)
    'DELTA': 0.38305,  # 容量阈值参数
    'BETA': 0.60875,  # 集合大小参数
    'PHI': 1.1718,  # 途中时间限制参数
